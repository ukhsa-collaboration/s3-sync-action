...
This repo is copy of `https://github.com/jakejarvis/s3-sync-action` repo.
The reason for having our own copy of repo is because it is not a good practice to just use a third party library outside of our control.
